  ...
  return (
    <section className="py-12 sm:py-20 lg:py-24 bg-neutral-lighter">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              <div className="relative h-full bg-white rounded-3xl p-6 sm:p-8 border-2 border-transparent hover:border-primary/20 transition-all duration-300 shadow-lg hover:shadow-2xl">
                ...
                {/* Challenge */}
                <div className="mb-6">
                  <h3 className="text-sm font-bold uppercase tracking-wide mb-2" style={{ color: '#374151' }}>
                    التحدي
                  </h3>
                ...
                {/* Results */}
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-wide mb-4" style={{ color: '#374151' }}>
                    النتائج
                  </h3>
        ...
        >
          <p className="text-base sm:text-lg" style={{ color: '#1F2937' }}>
